...
class CreatePationtAccountScreen extends StatefulWidget {
  static const routeName = '/create-pationt-account';
  const CreatePationtAccountScreen({super.key});

  @override
  State<CreatePationtAccountScreen> createState() => _CreatePationtAccountScreenState();
}

class _CreatePationtAccountScreenState extends State<CreatePationtAccountScreen> {
                  ...
                  Padding(
                      ...
                      child: ElevatedGradientButton(
                          onPressed: () {
                            ...
                            Navigator.of(context).pushNamed(ComplatePationInfoScreen.routeName,
